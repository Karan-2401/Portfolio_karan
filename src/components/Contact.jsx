  ...
  return (
    <div className='border-b border-neutral-600 pb-20 pt-10'>
      ...
      <div className='text-center tracking-tighter'>
        ...
        <motion.a whileInView={{opacity:1,x:0}} initial={{opacity:0,x:-100}} transition={{duration:1}} href="mailto:karan342772@gmail.com" className='my-4 underline'>karan342772@gmail.com</motion.a>
      </div>
    </div>
  )
}
